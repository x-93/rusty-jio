...
use jio_wallet_core::error::Error as WalletError;
...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] jio_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] jio_rpc_core::RpcError),
    ...
    #[error(transparent)]
    Daemon(#[from] jio_daemon::error::Error),
    ...
    #[error(transparent)]
    Bip32(#[from] jio_bip32::Error),

    #[error("private key {0} already exists")]
    PrivateKeyAlreadyExists(String),

    #[error(transparent)]
    MetricsError(jio_metrics_core::error::Error),

    #[error(transparent)]
    JioWalletKeys(#[from] jio_wallet_keys::error::Error),

    #[error(transparent)]
    PskbLockScriptSigError(#[from] jio_wallet_pskt::error::Error),
