Latest online documentation available at: https://jio.aspectron.org/docs/
...
- Merge with Rusty Jio master (0.13.6)
...
- Rename `jio-beacon` app to `jio-resolver`
...
- Introduced `Beacon` class that provides connectivity to the community-operated public node infrastructure (backed by `jio-beacon` load balancer & node status monitor)
...
- Changed documentation structure to use `typedoc` available as a part of redistributables or online at https://jio.aspectron.org/docs/
