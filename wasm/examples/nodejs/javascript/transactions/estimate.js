...
(async () => {
    ...
    console.info(`Full jio address: ${sourceAddress}`);
    ...
    if (!entries.length) {
        ...
        //
        // If the requested amount is greater than the Jio
        ...
        let generator = new Generator({
            entries,
            outputs: [{ address: sourceAddress, amount: jioToSompi(0.2) }],
            priorityFee: jioToSompi(0.0001),
