...
/// The main object to create for managing a fully-fledged Jio P2P peer
pub struct Adaptor {
    //
...
impl Adaptor {
    ...
    /// Creates a P2P adaptor with only client-side support. Typical Jio nodes should use `Adaptor::bidirectional`
