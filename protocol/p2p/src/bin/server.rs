use jio_core::debug;
use jio_p2p_lib::echo::EchoFlowInitializer;
...
async fn main() {
    // [-] - init logger
    jio_core::log::init_logger(None, "debug");
    ...
    let adaptor = jio_p2p_lib::Adaptor::bidirectional(ip_port, jio_p2p_lib::Hub::new(), initializer, Default::default()).unwrap();
