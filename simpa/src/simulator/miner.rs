...
use jio_consensus::consensus::Consensus;
use jio_consensus::model::stores::virtual_state::VirtualStateStoreReader;
use jio_consensus::params::Params;
use jio_consensus_core::api::ConsensusApi;
use jio_consensus_core::block::{Block, TemplateBuildMode, TemplateTransactionSelector};
use jio_consensus_core::coinbase::MinerData;
use jio_consensus_core::mass::{Kip9Version, MassCalculator};
use jio_consensus_core::sign::sign;
...
use jio_consensus_core::utxo::utxo_view::UtxoView;
use jio_core::trace;
use jio_utils::sim::{Environment, Process, Resumption, Suspension};
...
impl TemplateTransactionSelector for OnetimeTxSelector {
    ...
    fn reject_selection(&mut self, _tx_id: jio_consensus_core::tx::TransactionId) {
        unimplemented!()
    }
