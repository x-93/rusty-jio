...
use jio_consensus::config::Config;
...
use jio_database::{create_permanent_db, create_temp_db};
use jio_utils::fd_budget;
use jio_utils::sim::Simulation;

type ConsensusWrapper = (Arc<Consensus>, Vec<JoinHandle<()>>, DbLifetime);

pub struct JioNetworkSimulator {
