...
use js_sys::Array;
use jio_consensus_client::{sign_with_multiple_v3, Transaction};
use jio_consensus_core::hashing::wasm::SighashType;
use jio_consensus_core::sign::sign_input;
use jio_consensus_core::tx::PopulatedTransaction;
use jio_consensus_core::{hashing::sighash_type::SIG_HASH_ALL, sign::verify};
use jio_hashes::Hash;
use jio_wallet_keys::privatekey::PrivateKey;
use jio_wasm_core::types::HexString;
