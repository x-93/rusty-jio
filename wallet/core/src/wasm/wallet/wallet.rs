...
use jio_wallet_macros::declare_typescript_wasm_interface as declare;
use jio_wasm_core::events::{get_event_targets, Sink};
use jio_wrpc_wasm::{IConnectOptions, Resolver, RpcClient, RpcConfig, WrpcEncoding};
...
///
/// The Rusty Jio is developed in Rust, and the Wallet class is a Rust implementation
