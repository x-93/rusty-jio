//!
//! Jio Wallet Core - Multi-platform Rust framework for Jio Wallet.
//!
...
//! the `jio` module includes `websocket` module dependency simulating
...
extern crate alloc;
extern crate self as jio_wallet_core;
...
pub fn version_with_git_hash() -> String {
    jio_utils::git::with_short_hash(env!("CARGO_PKG_VERSION")).to_string()
}
