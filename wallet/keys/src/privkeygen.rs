...
/// This class accepts the master Jio XPrv string (e.g. `xprv1...`) and generates
...
///
/// Please note that in Jio master private keys use `kprv` prefix.
///
