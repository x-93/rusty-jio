...
use jio_consensus_core::{blockhash::ORIGIN, header::Header, BlockHashMap, BlockHasher, BlockLevel};
use jio_hashes::Hash;
...
mod tests {
    ...
    impl HeaderStoreReader for HeaderStoreMock {
        fn get_daa_score(&self, hash: jio_hashes::Hash) -> Result<u64, StoreError> {
            unimplemented!()
        }

        fn get_timestamp(&self, hash: jio_hashes::Hash) -> Result<u64, StoreError> {
            unimplemented!()
        }

        fn get_bits(&self, hash: jio_hashes::Hash) -> Result<u32, StoreError> {
            unimplemented!()
        }

        fn get_header(&self, hash: jio_hashes::Hash) -> Result<Arc<Header>, StoreError> {
        ...
        fn get_blue_score(&self, hash: jio_hashes::Hash) -> Result<u64, StoreError> {
            unimplemented!()
        }

        fn get_header_with_block_level(&self, hash: jio_hashes::Hash) -> Result<HeaderWithBlockLevel, StoreError> {
    ...
    impl RelationsStoreReader for RelationsStoreMock {
        fn get_parents(&self, hash: Hash) -> Result<jio_consensus_core::blockhash::BlockHashes, StoreError> {
            unimplemented!()
        }
