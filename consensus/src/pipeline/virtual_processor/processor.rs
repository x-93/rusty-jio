...
use jio_consensusmanager::SessionLock;
use jio_core::{debug, info, time::unix_now, trace, warn};
use jio_database::prelude::{StoreError, StoreResultEmptyTuple, StoreResultExtensions};
use jio_hashes::Hash;
use jio_muhash::MuHash;
use jio_notify::{events::EventType, notifier::Notify};

use super::errors::{PruningImportError, PruningImportResult};
use crossbeam_channel::{Receiver as CrossbeamReceiver, Sender as CrossbeamSender};
use itertools::Itertools;
use jio_consensus_core::tx::ValidatedTransaction;
use jio_utils::binary_heap::BinaryHeapExtensions;
...
impl VirtualStateProcessor {
    ...
    pub(crate) fn build_block_template_from_virtual_state(
        ...
        let accepted_id_merkle_root = jio_merkle::calc_merkle_root(virtual_state.accepted_tx_ids.iter().copied());
