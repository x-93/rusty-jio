...
use jio_consensusmanager::{ConsensusFactory, ConsensusInstance, DynConsensusCtl, SessionLock};
use jio_core::{debug, time::unix_now, warn};
use jio_database::{
    prelude::{
...
impl ConsensusFactory for Factory {
    fn new_active_consensus(&self) -> (ConsensusInstance, DynConsensusCtl) {
        ...
        let db = jio_database::prelude::ConnBuilder::default()
            .with_db_path(dir)
