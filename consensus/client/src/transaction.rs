...
use jio_consensus_core::network::NetworkTypeT;
use jio_consensus_core::subnets::{self, SubnetworkId};
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<jio_addresses::AddressArrayT> {
