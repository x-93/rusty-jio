...
use jio_core::jiopad_env::version;
use jio_notify::address::tracker::Tracker;
use jio_utils::networking::ContextualNetAddress;
use jio_wrpc_server::address::WrpcNetAddress;
...
impl Args {
    ...
    #[cfg(feature = "devnet-prealloc")]
    pub fn generate_prealloc_utxos(&self, num_prealloc_utxos: u64) -> jio_consensus_core::utxo::utxo_collection::UtxoCollection {
...
pub fn cli() -> Command {
    ...
    let cmd = Command::new("jiopad")
        .about(format!("{} (rusty-jio) v{}", env!("CARGO_PKG_DESCRIPTION"), version()))
...
/*
  ...
  -a, --addpeer=                            Add a peer to connect with at startup
      ...
      --rpccert=                            File containing the certificate file (default:
                                            /Users/aspect/Library/Application Support/Jiopad/rpc.cert)
      --rpckey=                             File containing the certificate key (default:
                                            /Users/aspect/Library/Application Support/Jiopad/rpc.key)
