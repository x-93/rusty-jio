...
use jio_consensus_notify::notification::{self as consensus_notify, Notification as ConsensusNotification};
use jio_consensusmanager::{ConsensusManager, ConsensusProxy};
use jio_math::Uint256;
use jio_mining::model::{owner_txs::OwnerTransactions, TransactionIdSet};
use jio_notify::converter::Converter;
use jio_rpc_core::{
...
use jio_txscript::{extract_script_pub_key_address, script_class::ScriptClass};
...
impl ConsensusConverter {
    ...
    ///
    /// _GO-JIOPAD: PopulateBlockWithVerboseData_
    ...
    ///
    /// _GO-JIOPAD: PopulateTransactionWithVerboseData
