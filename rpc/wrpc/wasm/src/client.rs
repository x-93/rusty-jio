...
use jio_addresses::{Address, AddressOrStringArrayT};
use jio_consensus_client::UtxoEntryReference;
use jio_consensus_core::network::{NetworkType, NetworkTypeT};
use jio_notify::connection::ChannelType;
use jio_notify::events::EventType;
use jio_notify::listener;
use jio_notify::notification::Notification as NotificationT;
use jio_rpc_core::api::ctl;
pub use jio_rpc_core::wasm::message::*;
pub use jio_rpc_macros::{
    build_wrpc_wasm_bindgen_interface, build_wrpc_wasm_bindgen_subscriptions, declare_typescript_wasm_interface as declare,
};
use jio_wasm_core::events::{get_event_targets, Sink};
...
pub struct Inner {
    ...
    notification_channel: Channel<jio_rpc_core::Notification>,
}
...
///
///
/// Jio RPC client uses ([wRPC](https://github.com/workflow-rs/workflow-rs/tree/master/rpc))
/// interface to connect directly with Jio Node. wRPC supports
/// two types of encodings: `borsh` (binary, default) and `json`.
///
/// There are two ways to connect: Directly to any Jio Node or to a
...
/// ```
///
/// **Connecting to a Jio Node directly**
///
/// ```javascript
/// let rpc = new RpcClient({
...
/// to re-register event listeners, but your have to re-subscribe for Jio node
/// notifications:
///
/// ```typescript
/// rpc.addEventListener("connect", async (event) => {
...
impl RpcClient {
    pub fn new(config: Option<RpcConfig>) -> Result<RpcClient> {
        ...
        let client = Arc::new(
            JioRpcClient::new(encoding, url.as_deref(), resolver.clone().map(Into::into), network_id, None)
...
impl RpcClient {
    ...
    /// Connect to the Jio RPC server. This function starts a background
    ...
    /// Disconnect from the Jio RPC server.
    ...
    /// however, you have to re-subscribe for Jio node notifications. As such, it is recommended
...
impl RpcClient {
    pub fn new_with_rpc_client(client: Arc<JioRpcClient>) -> RpcClient {
    ...
    pub fn client(&self) -> &Arc<JioRpcClient> {
        &self.inner.client
    }
                ...
                select_biased! {
                    ...
                    msg = notification_receiver.recv().fuse() => {
                        if let Ok(notification) = &msg {
                            match &notification {
                                jio_rpc_core::Notification::UtxosChanged(utxos_changed_notification) => {
...
impl RpcClient {
    ...
    pub fn parse_url(url: &str, encoding: Encoding, network: NetworkId) -> Result<String> {
        let url_ = JioRpcClient::parse_url(url.to_string(), encoding, network.into())?;
        Ok(url_)
    }
}
...
impl RpcClient {
    ...
    /// Difficulty Adjustment Algorithm (DAA) score changes in the Jio BlockDAG.
    ...
    /// Jio BlockDAG. The event notification will be scoped to the
    ...
    /// chain changes in the Jio BlockDAG.
...
build_wrpc_wasm_bindgen_subscriptions!([
    ...
    /// block is added to the Jio BlockDAG.
    BlockAdded,
    ...
    /// conflict occurs in the Jio BlockDAG.
    FinalityConflict,
    ...
    /// conflict in the Jio BlockDAG is resolved.
    ...
    /// score of the sink block changes in the Jio BlockDAG.
    ...
    /// UTXO set override for the pruning point changes in the Jio BlockDAG.
    ...
    /// template is generated for mining in the Jio BlockDAG.
    NewBlockTemplate,
]);
...
build_wrpc_wasm_bindgen_interface!(
    [
        ...
        /// Retrieves the current number of blocks in the Jio BlockDAG.
        ...
        GetBlockDagInfo,
        /// Returns the total current coin supply of Jio network.
        /// Returned information: Total coin supply.
        GetCoinSupply,
        /// Retrieves information about the peers connected to the Jio node.
        /// Returned information: Peer ID, IP address and port, connection
        /// status, protocol version.
        GetConnectedPeerInfo,
        /// Retrieves general information about the Jio node.
        /// Returned information: Version of the Jio node, protocol
        /// version, network identifier.
        /// This call is primarily used by gRPC clients.
        /// For wRPC clients, use {@link RpcClient.getServerInfo}.
        GetInfo,
        /// Provides a list of addresses of known peers in the Jio
        ...
        /// performance and status of the Jio node.
        ...
        /// the highest cumulative difficulty in the Jio BlockDAG.
        ...
        GetSinkBlueScore,
        /// Tests the connection and responsiveness of a Jio node.
        /// Returned information: None.
        Ping,
        /// Gracefully shuts down the Jio node.
        /// Returned information: None.
        Shutdown,
        /// Retrieves information about the Jio server.
        /// Returned information: Version of the Jio server, protocol
        /// version, network identifier.
        GetServerInfo,
        /// Obtains basic information about the synchronization status of the Jio node.
        /// Returned information: Syncing status.
        GetSyncStatus,
    ],
    [
        // functions with `request` argument
        /// Adds a peer to the Jio node's list of known peers.
        /// Returned information: None.
        AddPeer,
        /// Bans a peer from connecting to the Jio node for a specified duration.
        /// Returned information: None.
        Ban,
        ...
        /// Retrieves the balance of a specific address in the Jio BlockDAG.
        /// Returned information: Balance of the address.
        GetBalanceByAddress,
        /// Retrieves balances for multiple addresses in the Jio BlockDAG.
        /// Returned information: Balances of the addresses.
        GetBalancesByAddresses,
        /// Retrieves a specific block from the Jio BlockDAG.
        /// Returned information: Block information.
        GetBlock,
        /// Retrieves multiple blocks from the Jio BlockDAG.
        ...
        GetCurrentNetwork,
        /// Retrieves block headers from the Jio BlockDAG.
        /// Returned information: List of block headers.
        GetHeaders,
        /// Retrieves mempool entries from the Jio node's mempool.
        ...
        GetMempoolEntry,
        /// Retrieves information about a subnetwork in the Jio BlockDAG.
        ...
        /// Resolves a finality conflict in the Jio BlockDAG.
        /// Returned information: None.
        ResolveFinalityConflict,
        /// Submits a block to the Jio network.
        /// Returned information: None.
        SubmitBlock,
        /// Submits a transaction to the Jio network.
        /// Returned information: Submitted Transaction Id.
        SubmitTransaction,
        /// Submits an RBF transaction to the Jio network.
