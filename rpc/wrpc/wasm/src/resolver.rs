...
use crate::imports::*;
use js_sys::Array;
pub use jio_rpc_macros::declare_typescript_wasm_interface as declare;
use jio_wrpc_client::node::NodeDescriptor;
use jio_wrpc_client::Resolver as NativeResolver;
use serde::ser;
...
///
/// Resolver is a client for obtaining public Jio wRPC URL.
///
/// Resolver queries a list of public Jio Resolver URLs using HTTP to fetch
...
#[wasm_bindgen]
impl Resolver {
    /// List of public Jio Resolver URLs.
    #[wasm_bindgen(getter)]
    ...
    /// Fetches a public Jio wRPC endpoint for the given encoding and network identifier.
    ...
    /// Fetches a public Jio wRPC endpoint URL for the given encoding and network identifier.
    ...
    /// Connect to a public Jio wRPC endpoint for the given encoding and network identifier
