...
use jio_rpc_core::{FromRpcHex, RpcError, RpcHash, RpcResult, RpcScriptVec, ToRpcHex};
use std::str::FromStr;
...
from!(item: &jio_rpc_core::RpcTransaction, protowire::RpcTransaction, {
    Self {
...
from!(item: &jio_rpc_core::RpcTransactionInput, protowire::RpcTransactionInput, {
    Self {
...
from!(item: &jio_rpc_core::RpcTransactionOutput, protowire::RpcTransactionOutput, {
    Self {
        amount: item.value,
...
from!(item: &jio_rpc_core::RpcTransactionOutpoint, protowire::RpcOutpoint, {
    Self { transaction_id: item.transaction_id.to_string(), index: item.index }
});

from!(item: &jio_rpc_core::RpcUtxoEntry, protowire::RpcUtxoEntry, {
    Self {
        amount: item.amount,
        script_public_key: Some((&item.script_public_key).into()),
...
from!(item: &jio_rpc_core::RpcScriptPublicKey, protowire::RpcScriptPublicKey, {
    Self { version: item.version().into(), script_public_key: item.script().to_rpc_hex() }
});

from!(item: &jio_rpc_core::RpcTransactionVerboseData, protowire::RpcTransactionVerboseData, {
    Self {
...
from!(&jio_rpc_core::RpcTransactionInputVerboseData, protowire::RpcTransactionInputVerboseData);

from!(item: &jio_rpc_core::RpcTransactionOutputVerboseData, protowire::RpcTransactionOutputVerboseData, {
    Self {
...
from!(item: &jio_rpc_core::RpcAcceptedTransactionIds, protowire::RpcAcceptedTransactionIds, {
    Self {
...
from!(item: &jio_rpc_core::RpcUtxosByAddressesEntry, protowire::RpcUtxosByAddressesEntry, {
    Self {
...
try_from!(item: &protowire::RpcTransaction, jio_rpc_core::RpcTransaction, {
    Self {
        version: item.version.try_into()?,
        inputs: item
            .inputs
            .iter()
            .map(jio_rpc_core::RpcTransactionInput::try_from)
            .collect::<RpcResult<Vec<jio_rpc_core::RpcTransactionInput>>>()?,
        outputs: item
            .outputs
            .iter()
            .map(jio_rpc_core::RpcTransactionOutput::try_from)
            .collect::<RpcResult<Vec<jio_rpc_core::RpcTransactionOutput>>>()?,
        lock_time: item.lock_time,
        subnetwork_id: jio_rpc_core::RpcSubnetworkId::from_str(&item.subnetwork_id)?,
        gas: item.gas,
        payload: Vec::from_rpc_hex(&item.payload)?,
        mass: item.mass,
        verbose_data: item.verbose_data.as_ref().map(jio_rpc_core::RpcTransactionVerboseData::try_from).transpose()?,
    }
});

try_from!(item: &protowire::RpcTransactionInput, jio_rpc_core::RpcTransactionInput, {
    Self {
        ...
        verbose_data: item.verbose_data.as_ref().map(jio_rpc_core::RpcTransactionInputVerboseData::try_from).transpose()?,
    }
});

try_from!(item: &protowire::RpcTransactionOutput, jio_rpc_core::RpcTransactionOutput, {
    Self {
        value: item.amount,
        script_public_key: item
            ...
            .try_into()?,
        verbose_data: item.verbose_data.as_ref().map(jio_rpc_core::RpcTransactionOutputVerboseData::try_from).transpose()?,
    }
});

try_from!(item: &protowire::RpcOutpoint, jio_rpc_core::RpcTransactionOutpoint, {
    Self { transaction_id: RpcHash::from_str(&item.transaction_id)?, index: item.index }
});

try_from!(item: &protowire::RpcUtxoEntry, jio_rpc_core::RpcUtxoEntry, {
    Self {
        amount: item.amount,
        script_public_key: item
            .script_public_key
...
try_from!(item: &protowire::RpcScriptPublicKey, jio_rpc_core::RpcScriptPublicKey, {
    Self::new(u16::try_from(item.version)?, RpcScriptVec::from_rpc_hex(item.script_public_key.as_str())?)
});

try_from!(item: &protowire::RpcTransactionVerboseData, jio_rpc_core::RpcTransactionVerboseData, {
    Self {
...
try_from!(&protowire::RpcTransactionInputVerboseData, jio_rpc_core::RpcTransactionInputVerboseData);

try_from!(item: &protowire::RpcTransactionOutputVerboseData, jio_rpc_core::RpcTransactionOutputVerboseData, {
    Self {
...
try_from!(item: &protowire::RpcAcceptedTransactionIds, jio_rpc_core::RpcAcceptedTransactionIds, {
    Self {
...
try_from!(item: &protowire::RpcUtxosByAddressesEntry, jio_rpc_core::RpcUtxosByAddressesEntry, {
