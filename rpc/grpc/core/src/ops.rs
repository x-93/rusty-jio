use crate::protowire::{jiopad_request::Payload as RequestPayload, jiopad_response::Payload as ResponsePayload, *};
...
pub enum JiopadPayloadOps {
    ...
    // The conversion from a notification ResponsePayload into JiopadPayloadOps fails.
}
}
