use crate::{
    error::{Error, Result},
    resolver::{JiopadResponseReceiver, JiopadResponseSender, Resolver},
};
use jio_core::trace;
use jio_grpc_core::{
...
impl Pending {
    fn new(sender: JiopadResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: JiopadPayloadOps, request: &JiopadRequest) -> JiopadResponseReceiver {
