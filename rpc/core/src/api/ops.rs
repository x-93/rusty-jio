...
pub enum RpcApiOps {
    ...
    GetSyncStatus = 115,
    /// Returns the network this Jiopad is connected to (Mainnet, Testnet)
    ...
    /// Returns a list of all the addresses (IP, port) this Jiopad knows and a list of all addresses that are currently banned by this Jiopad
    ...
    /// Returns a list of the peers currently connected to this Jiopad, along with some statistics on them
    GetConnectedPeerInfo = 123,
    /// Instructs Jiopad to connect to a given IP address.
    AddPeer = 124,
