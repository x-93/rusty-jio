...
use jio_utils::serde_bytes_fixed_ref;
...
impl From<jio_consensus_client::TransactionOutpoint> for RpcTransactionOutpoint {
    fn from(outpoint: jio_consensus_client::TransactionOutpoint) -> Self {
        TransactionOutpoint::from(outpoint).into()
    }
}

impl From<RpcTransactionOutpoint> for jio_consensus_client::TransactionOutpoint {
    fn from(outpoint: RpcTransactionOutpoint) -> Self {
        TransactionOutpoint::from(outpoint).into()
    }
}
